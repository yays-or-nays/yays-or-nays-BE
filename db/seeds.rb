...
software.hot_takes.create!(picture: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7PfyqeJD2TWb20o22uwCMrVCJVKDfi6AePD6uLCZZud_VMBBu&s", question: "Javascript is a good coding language", yes_vote: 1)
software.hot_takes.create(picture: "https://www.zdnet.com/a/hub/i/r/2018/11/10/b17cc654-deac-44fe-b603-586d20602b5f/thumbnail/770x578/92e095da546979ad55d9aeb1c99c189a/ruby-programming-language.png", question: "Ruby is a great beginner coding language", yes_vote: 3)
software.hot_takes.create(picture: "https://javapapers.com/wp-content/uploads/2011/01/DoubleBraceInitialization.jpg", question: "Javascript has too many unecessary brackets", yes_vote: 2)
software.hot_takes.create(picture: "https://user-images.githubusercontent.com/11014462/32064927-988dfaba-ba7b-11e7-9c5b-4e945f2c6deb.png", question: "If you use VS Code and don't use the built in terminal it's weird", yes_vote: 1, no_vote: 1)
software.hot_takes.create(picture: "https://raw.githubusercontent.com/akamud/vscode-theme-onelight/master/screenshots/preview.png", question: "Light mode on any application is terrible", yes_vote: 1, no_vote: 2)
